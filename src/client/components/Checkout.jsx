...
export default function Checkout({ cartItems, setCartItems, checkoutOpen, handleCheckoutClose, handleCloseSnackbar, isIkea }) {
  ...
  const getAvailableTimes = (date) => {
    ...
    if ([1, 2, 5, 6].includes(day)) {
      return ['8:00 AM', '8:30 AM', '9:00 AM', '9:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM', '12:00 PM', '12:30 PM', '1:00 PM', '1:30 PM', '2:00 PM', '2:30 PM', '3:00 PM', '3:30 PM', '4:00 PM', '4:30 PM', '5:00 PM', '5:30 PM', '6:00 PM', '6:30 PM', '7:00 PM'];
    }

    if ([3, 4].includes(day)) {
      return ['10:00 AM', '10:30 AM', '11:00 AM', '11:30AM', '12:00 PM', '12:30 PM', '1:00 PM'];
    }
  ...
  const submitOrder = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setErrorMessage(`Order submission failed: ${JSON.stringify(data.error) || 'Something went wrong.'}`);
        setErrorMessageOpen(true);
      }
    } catch (error) {
      console.log(error)
              ...
              <Grid container spacing={2} direction='column'>
                ...
                <Grid>
                  {formData.date && (
                    <Typography variant="subtitle1" sx={{ mb: 1 }}>
                      Selected Date: {dayjs(formData.date).format('dddd, MMMM D, YYYY')}
                    </Typography>
                  )}
                </Grid>
                ...
                <Grid>
                  <FormControl fullWidth required sx={{ mt: 2 }}>
                    ...
                    >
                      {getAvailableTimes(formData.date).map((timeStr) => (
                ...
                <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center' }}>
                  ...
                  <Stack>
                    <Button
                      ...
                      disabled={isIkea && (cartItems.length < 1) || isSubmitting}
                    >
                      {isSubmitting ? 'Booking assembly date & time...' : 'Book Assembly'}
                    </Button>
                    ...
                    <Button
                      ...
                      {...(isIkea && { onClick: handleCheckoutClose })}
                      {...(!isIkea && {
                        component: Link,
                        to: '/'
                      })}
